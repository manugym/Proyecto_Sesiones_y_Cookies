...
public class Catalogo {
    ...
    /*
    En este método simplemente se eliminan los carácteres que no son admitidos
    así evitamos problemas la hora de trabajar con las cadenas de caracteres
     */
    public void cargaDatos() {
        productos.clear();
        productos.add(new Producto(1, "Pelikan_Souveran_M-1000", 545, "pelikan.jpg"));
